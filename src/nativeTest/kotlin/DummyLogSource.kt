    ...
    companion object {
        val lines =
            listOf(
                ...
                // "W/Looper  ( 2573): Slow delivery took 4921ms main h=android.os.Handler
                // c=com.android.internal.os.BinderCallsStats\$1@a16bc63 m=0",
                // "V/GraphicsEnvironment(15121): ANGLE Developer option for 'com.android.chrome'
                // set to: 'default'",
                // "V/GraphicsEnvironment(15121): Neither updatable production driver nor prerelease
                // driver is supported."
            )
    }
